  ...
  <style>
    * {
    ...
    body {
      ...
      background: linear-gradient(145deg, #0a3e32 0%, #217555 45%, #fff8e5 100%);
      color: #02281e;
      line-height: 1.5;
    }
    ...
    /* ===== MENU GRID - BANYAK FOTO VARIATIF ===== */
    .menu-grid {
      display: grid;
    ...
    .menu-card:hover {
      ...
      background: white;
      border-color: #ffc164;
      box-shadow: 0 30px 35px -8px #000f0c;
    }

    /* FOTO MENU - BANYAK VARIASI, UKURAN BESAR, HD */
    .menu-card img {
      width: 100%;
      height: 240px;
      object-fit: cover;
    ...
    /* ===== POPUP METODE - HANYA CASH DAN QR ===== */
    .popup-method {
      position: fixed;
...
<header>
  <h1>🧊 FRESH BREW</h1>
  <p>🍹 100% FOTO ASLI MINUMAN</p>
</header>

<div class="container">

  <!-- ========== MENU DENGAN 15+ FOTO VARIATIF ========= -->
  <div class="section-title">🥤 MENU SEGAR · FOTO HD</div>
...
<!-- POPUP 1: PILIH METODE - HANYA CASH DAN QR -->
<div class="popup-method" id="popupMetode">
  <div class="method-container">
    ...
    <div class="method-flex">
      ...
      <button class="btn-metode" onclick="prosesMetode('QRIS')">📱 QR CODE</button>
    </div>
...
<!-- POPUP 2: QR CODE - MURNI QR + NOMOR -->
<div class="popup-qr" id="popupQR">
  <div class="qr-panel">
    <h3>📱 QR PAY</h3>
    <div id="qrcode"></div>
    <div class="nomor-qr">0838 7216 1233</div>
...
<script>
  // ========== MENU DENGAN 15 FOTO VARIATIF ==========
  const menu = [
    // FOTO 1-5: VARIAN TEH DAN KOPI
    { nama: "Es Teh Manis", harga: 5000, gambar: "https://images.unsplash.com/photo-1556679343-c1c1c1d56c6d?w=700&auto=format&fit=crop&q=85" },
    { nama: "Es Teh Lemon", harga: 8000, gambar: "https://images.unsplash.com/photo-1558640479-8242c0c8b9b9?w=700&auto=format&fit=crop&q=85" },
    { nama: "Thai Tea", harga: 12000, gambar: "https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=700&auto=format&fit=crop&q=85" },
    { nama: "Matcha Latte", harga: 15000, gambar: "https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=700&auto=format&fit=crop&q=85" },
    { nama: "Es Kopi Susu", harga: 13000, gambar: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=700&auto=format&fit=crop&q=85" },
    
    // FOTO 6-10: VARIAN KOPI DAN COKLAT
    { nama: "Cappuccino", harga: 15000, gambar: "https://images.unsplash.com/photo-1511920170033-f8396924c348?w=700&auto=format&fit=crop&q=85" },
    { nama: "Americano", harga: 12000, gambar: "https://images.unsplash.com/photo-1498804103079-a6351b050096?w=700&auto=format&fit=crop&q=85" },
    { nama: "Kopi Gula Aren", harga: 14000, gambar: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=700&auto=format&fit=crop&q=85" },
    { nama: "Chocolate Ice", harga: 15000, gambar: "https://images.unsplash.com/photo-1572490122747-3968b75cc699?w=700&auto=format&fit=crop&q=85" },
    { nama: "Mocha Frappe", harga: 16000, gambar: "https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=700&auto=format&fit=crop&q=85" },
    
    // FOTO 11-15: VARIAN SMOOTHIE DAN TEH LAINNYA
    { nama: "Lychee Tea", harga: 13000, gambar: "https://images.unsplash.com/photo-1556679343-c1c1c1d56c6d?w=700&bri=1.1&con=5&q=85" },
    { nama: "Mango Smoothie", harga: 18000, gambar: "https://images.unsplash.com/photo-1558640479-8242c0c8b9b9?w=700&bri=1.2&sat=10&q=85" },
    { nama: "Taro Latte", harga: 15000, gambar: "https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=700&bri=0.95&con=8&q=85" },
    { nama: "Red Velvet", harga: 17000, gambar: "https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=700&sat=15&q=85" },
    { nama: "Vanilla Shake", harga: 17000, gambar: "https://images.unsplash.com/photo-1572490122747-3968b75cc699?w=700&bri=1.1&con=6&q=85" },
    
    // TAMBAHAN 3 FOTO UNTUK VARIASI
    { nama: "Caramel Macchiato", harga: 18000, gambar: "https://images.unsplash.com/photo-1485808191679-5f86510681a2?w=700&auto=format&fit=crop&q=85" },
    { nama: "Hazelnut Coffee", harga: 16000, gambar: "https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=700&auto=format&fit=crop&q=85" },
    { nama: "Strawberry Smoothie", harga: 19000, gambar: "https://images.unsplash.com/photo-1553530979-7ee52a2670c4?w=700&auto=format&fit=crop&q=85" }
  ];
  ...
  window.prosesMetode = function(metode) {
    ...
    if (metode === "Cash") {
      ...
      // QR CODE: TAMPILKAN QR + OTOMATIS WA KE TOKO
      tampilkanQR();
      kirimWaKeToko("QRIS");
    }
  };
  ...
  function tampilkanQR() {
    ...
    // Nomor tujuan
    const nomorTujuan = "0838 7216 1233";
    
    // Isi QR Code - LANGSUNG NOMOR
    let qrText = "083872161233";
  ...
  function kirimWaKeToko(metodeBayar) {
    ...
    if (metodeBayar === "QRIS") {
      pesan += `✅ *Pembayaran via QR CODE*%0A`;
